...
int main(int argc, char **argv) {
  ...
  cudaMallocHost(&hostA, sizeof(DataType) * numARows * numAColumns);
  cudaMallocHost(&hostB, sizeof(DataType) * numBRows * numBColumns);
  cudaMallocHost(&hostC, sizeof(DataType) * numCRows * numCColumns);
